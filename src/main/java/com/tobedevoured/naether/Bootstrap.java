...
public final class Bootstrap {
	...
	static {
		...
		deps.add("org.sonatype.aether:aether-api:jar:1.13");
		deps.add("org.sonatype.aether:aether-util:jar:1.13");
		deps.add("org.sonatype.aether:aether-impl:jar:1.13");
		deps.add("org.sonatype.aether:aether-spi:jar:1.13");
		deps.add("org.sonatype.aether:aether-connector-file:jar:1.13");
		deps.add("org.sonatype.aether:aether-connector-asynchttpclient:jar:1.13");
		deps.add("org.sonatype.aether:aether-connector-wagon:jar:1.13");
